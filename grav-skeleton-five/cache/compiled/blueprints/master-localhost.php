...
return [
    ...
    'timestamp' => 1636310140,
    'checksum' => 'b7bd9bbde4e6fb066cef80c5d3c04876',
    'files' => [
        ...
        'user/themes' => [
            ...
            'themes/timer' => [
                'file' => 'user/themes/timer/blueprints.yaml',
                'modified' => 1636295858
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'themes.timer.copyright' => [
                'type' => 'textarea',
                'rows' => 5,
                'label' => 'THEME.ADMIN.COPYRIGHT.LABEL',
                'name' => 'themes.timer.copyright',
                'validation' => 'loose'
            ],
            'themes.timer.logo' => [
                'type' => 'filepicker',
                ...
                'name' => 'themes.timer.logo',
                'validation' => 'loose'
            ],
            'themes.timer.favicon' => [
                'type' => 'text',
                'label' => 'THEME.ADMIN.FAVICON.LABEL',
                'name' => 'themes.timer.favicon',
                'validation' => 'loose'
            ],
            'themes.timer.social_icons' => [
                'type' => 'list',
                'label' => 'THEME.ADMIN.SOCIAL_ICONS',
                'name' => 'themes.timer.social_icons',
                'validation' => 'loose'
            ],
            'themes.timer.social_icons.url' => [
                'type' => 'text',
                'label' => 'THEME.ADMIN.URL',
                'name' => 'themes.timer.social_icons.url',
                'validation' => 'loose'
            ],
            'themes.timer.social_icons.classes' => [
                'type' => 'text',
                'label' => 'THEME.ADMIN.CLASSES',
                'name' => 'themes.timer.social_icons.classes',
                'validation' => 'loose'
            ],
            'themes.timer.social_icons.icon' => [
                'type' => 'text',
                'label' => 'THEME.ADMIN.ICON',
                'name' => 'themes.timer.social_icons.icon',
                'validation' => 'loose'
            ],
            'themes.timer.cta' => [
                'type' => 'section',
                'name' => 'themes.timer.cta',
                'validation' => 'loose'
            ],
            'themes.timer.cta.title' => [
                'type' => 'text',
                'label' => 'THEME.ADMIN.TITLE',
                'name' => 'themes.timer.cta.title',
                'validation' => 'loose'
            ],
            'themes.timer.cta.content' => [
                'type' => 'editor',
                'label' => 'THEME.ADMIN.CONTENT',
                'name' => 'themes.timer.cta.content',
                'validation' => 'loose'
            ],
            'themes.timer.cta.button_url' => [
                'type' => 'text',
                'label' => 'THEME.ADMIN.BUTTON_URL',
                'name' => 'themes.timer.cta.button_url',
                'validation' => 'loose'
            ],
            'themes.timer.cta.button_label' => [
                'type' => 'text',
                'label' => 'THEME.ADMIN.BUTTON_LABEL',
                'name' => 'themes.timer.cta.button_label',
                'validation' => 'loose'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
            ...
            'themes' => [
                ...
                'timer' => [
                    'copyright' => 'themes.timer.copyright',
                    'logo' => 'themes.timer.logo',
                    'favicon' => 'themes.timer.favicon',
                    'social_icons' => [
                        'url' => 'themes.timer.social_icons.url',
                        'classes' => 'themes.timer.social_icons.classes',
                        'icon' => 'themes.timer.social_icons.icon'
                    ],
                    'cta' => [
                        'title' => 'themes.timer.cta.title',
                        'content' => 'themes.timer.cta.content',
                        'button_url' => 'themes.timer.cta.button_url',
                        'button_label' => 'themes.timer.cta.button_label'
                    ]
                ]
            ]
        ],
